...
class HanhChinhLegacyColumnImport implements ToCollection, WithStartRow, WithColumnLimit
{
    ...
    public function __construct(
        ...
        $this->columnMap = HanhChinhImportColumnMap::resolve($columnMap);
    }
    ...
    public function collection(Collection $rows): void
    {
        foreach ($rows as $row) {
            ...
            if (HanhChinhImportColumnMap::isEmptyRow($parsed)) {
                continue;
            }
    ...
    {
        return HanhChinhImportColumnMap::IMPORT_END_COLUMN;
    }
